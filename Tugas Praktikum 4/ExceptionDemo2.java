...
a. Ketik huruf untuk digunakan sebagai input bilangan pertama kemudian klik ENTER.
   ...
   => Pada program ini ketika user menginputkan huruf atau selain angka maka user akan diminta untuk menginputkan
      ulang karena program telah menangkap Exception, jadi program akan tetap berjalan. Sedangkan, pada ExceptionDemo1
      program akan mengalami error karena adanya InputMismatchException
